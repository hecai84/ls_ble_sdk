...
struct TIM_DMA_Env
{
    uint8_t Channel;             /**< Configure DMA channels */
};

struct TIM_Interrupt_Env
{
    uint8_t *data;           /**< An pointer dma data */
    uint16_t count;          /**< Configure the size dma data */
};
...
typedef struct
{
  ...
  void *DMAC_Instance;
      union{
        struct TIM_DMA_Env DMA;  /**< DMA Env */
        struct TIM_Interrupt_Env Interrupt; /**< Interrupt Env */
