...
XIP_BANNED void power_down_config()
{
    ...
    SYSC_AWO->PWR_CTRL0 =
      FIELD_BUILD(SYSC_AWO_PD_EN_SEC, 0x0)
    | FIELD_BUILD(SYSC_AWO_PD_EN_BLE, 0x0)
    | FIELD_BUILD(SYSC_AWO_PD_EN_PER, 0x0)
    | FIELD_BUILD(SYSC_AWO_PD_EN_SRAM, 0x30)
    | FIELD_BUILD(SYSC_AWO_PU_EN_SEC, 0x0)
    | FIELD_BUILD(SYSC_AWO_PU_EN_BLE, 0x0)
    | FIELD_BUILD(SYSC_AWO_PU_EN_PER, 0x0)
    | FIELD_BUILD(SYSC_AWO_PU_EN_SRAM, 0x0);
SYSC_AWO->AWO_CTRL=
      FIELD_BUILD(SYSC_AWO_CLK_CLS_SET, 0x0)
    | FIELD_BUILD(SYSC_AWO_CLK_CLS_CLR, 0x0)
    | FIELD_BUILD(SYSC_AWO_RST_ACT_SET, 0x0)
    | FIELD_BUILD(SYSC_AWO_RST_ACT_CLR, 0x0)
    | FIELD_BUILD(SYSC_AWO_ISO_EN_SET, 0x1)
    | FIELD_BUILD(SYSC_AWO_ISO_EN_CLR, 0x0)
    | FIELD_BUILD(SYSC_AWO_PWR_OFF_SET, 0x0)
    | FIELD_BUILD(SYSC_AWO_PWR_OFF_CLR, 0x0);
SYSC_AWO->AWO_CTRL=
      FIELD_BUILD(SYSC_AWO_CLK_CLS_SET, 0x0)
    | FIELD_BUILD(SYSC_AWO_CLK_CLS_CLR, 0x0)
    | FIELD_BUILD(SYSC_AWO_RST_ACT_SET, 0x0)
    | FIELD_BUILD(SYSC_AWO_RST_ACT_CLR, 0x0)
    | FIELD_BUILD(SYSC_AWO_ISO_EN_SET, 0x0)
    | FIELD_BUILD(SYSC_AWO_ISO_EN_CLR, 0x0)
    | FIELD_BUILD(SYSC_AWO_PWR_OFF_SET, 0x1)
    | FIELD_BUILD(SYSC_AWO_PWR_OFF_CLR, 0x0);
  SYSC_AWO->PWR_CTRL2 =
      FIELD_BUILD(SYSC_AWO_PD_SRAM_DS_EN, 0)
  ...
  V33_RG->TRIM3 =
    ...
    | FIELD_BUILD(V33_RG_LPLDO_TRIM, 0x0)
